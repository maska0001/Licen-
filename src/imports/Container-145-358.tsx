import svgPaths from "./svg-2eijfmcedo";

function Heading() {
  return (
    <div className="h-[21px] relative shrink-0 w-[94.602px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#6a7282] text-[14px] text-nowrap top-0 tracking-[-0.3008px]">Lista de invitați</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[54px] relative shrink-0 w-[244px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[54px] left-0 not-italic text-[#101828] text-[36px] text-nowrap top-[0.5px] tracking-[0.3691px]">8</p>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[21px] relative shrink-0 w-[69.227px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#6a7282] text-[14px] text-nowrap top-0 tracking-[-0.3008px]">Buget total</p>
      </div>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[54px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[54px] left-0 not-italic text-[#101828] text-[36px] text-nowrap top-[0.5px] tracking-[0.3691px]">96,000</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[21px] relative shrink-0 w-[117.383px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#6a7282] text-[14px] text-nowrap top-0 tracking-[-0.3008px]">Sarcini completate</p>
      </div>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="absolute h-[54px] left-[25px] top-[62px] w-[244px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[54px] left-0 not-italic text-[#101828] text-[36px] text-nowrap top-[0.5px] tracking-[0.3691px]">3</p>
      <Text7 />
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="h-[21px] relative shrink-0 w-[112.102px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#6a7282] text-[14px] text-nowrap top-0 tracking-[-0.3008px]">Furnizori selectați</p>
      </div>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="absolute h-[54px] left-[25px] top-[62px] w-[244px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[54px] left-0 not-italic text-[#101828] text-[36px] text-nowrap top-[0.5px] tracking-[0.3691px]">0</p>
      <Text11 />
    </div>
  );
}

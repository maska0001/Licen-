import svgPaths from "./svg-8lmvu5vw51";
...
function Navigation() {
  return (
    <div className="bg-white h-[65px] relative shrink-0 w-full" data-name="Navigation">
...
function Frame() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-[279px]">
      <Container5 />
      <Container6 />
    </div>
  );

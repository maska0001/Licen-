import svgPaths from "./svg-xitua4rool";
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] text-nowrap top-[-0.5px] tracking-[-0.625px] uppercase">Decor Candy Bar</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="h-[18px] relative shrink-0 w-[109.641px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#6a7282] text-[12px] top-px w-[110px]">Estimat: 1,450 MDL</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[18px] relative shrink-0 w-[5.664px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#6a7282] text-[12px] text-nowrap top-px">•</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[18px] relative shrink-0 w-[83.719px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#6a7282] text-[12px] top-px w-[84px]">Achitat: 0 MDL</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="bg-[#fef2f2] h-[19px] relative rounded-[1.67772e+07px] shrink-0 w-[74.219px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[15px] left-[8px] not-italic text-[#c10007] text-[10px] text-nowrap top-[2.5px] tracking-[0.1172px] uppercase">Neachitat</p>
      </div>
    </div>
  );
}
